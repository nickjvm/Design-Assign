 <div class="container" id="main-region">
    ...
    <div class="row">
        <div class="control-group span8 <?php if (form_error('title')) echo 'error'; ?>">
            ...
            <input type="text" name="title" class="span8" value="<?php echo isset($post) ? $post->title : set_value('title'); ?>" />
        </div>
    ...
    <div class="row">
        ...
        <div class="span3">
            <div class="control-group <?php if (form_error('hours')) echo 'error'; ?>">
                ...
                <select name="hours" class="span3" id="hours" value="<?php echo isset($post) ? $post->hours : set_value('hours'); ?>">
    ...
    <div class="control-group <?php if (form_error('audience')) echo 'error'; ?>">
        ...
        <input type="text" id="audience" name="audience" class="span8" value="<?php echo isset($post) ? $post->audience : set_value('audience'); ?>" />
    </div>
    ...
    <div class="control-group <?php if (form_error('message')) echo 'error'; ?>">
        ...
        <input type="text" id="message" name="message" class="span8" value="<?php echo isset($post) ? $post->message : set_value('message'); ?>" />
    </div>
    ...
    <div class="control-group <?php if (form_error('deliverables')) echo 'error'; ?>">
        ...
        <input type="text" id="deliverables" name="deliverables" class="span8" value="<?php echo isset($post) ? $post->deliverables : set_value('deliverables'); ?>" />
    </div>
    ...
    <div class="control-group <?php if (form_error('goals')) echo 'error'; ?>">
        ...
        <input type="text" id="goals" name="goals" class="span8" value="<?php echo isset($post) ? $post->goals : set_value('goals'); ?>" />
    </div>
    ...
    <div class="control-group <?php if (form_error('body')) echo 'error'; ?>">
        ...
        <div class="controls">
            <textarea name="body" id="body" class="span8" rows="5"><?php echo isset($post) ? $post->body : set_value('body') ?></textarea>
    ...
    <div class="row">
        <div class="span8">
            ...
            <p>
                ...
                to consider it for use with Design Assign 2014. I also understand that AIGA Iowa is not 
