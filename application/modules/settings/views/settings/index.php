			...
			<div class="tab-content" style="padding-bottom: 9px; border-bottom: 1px solid #ddd;">
				...
				<div class="tab-pane active" id="main-settings">
					<fieldset>
						...
						<div class="control-group">
							<label class="control-label" for="title">[NT] Logo</label>
							<div class="controls">
								<input type="file" name="logo" id="logo" class="span3" />
								<p class="help-inline">[NT] Select an image file to use as the site logo (.png, .jpg, .gif)</p>
							</div>
						</div>
