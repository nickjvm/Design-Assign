<div class="container-ajax">
	<h2 class="title">Volunteer Submission Received!</h2>
	<h4>Thank you for volunteering for <?php print $project->title;?> 
		If you are selected for the project, we will notify you in June.

	</h4>

	<h4>Please feel free to volunteer for another project! If you have any
		questions, please contact Design Assign at 
		<a href="mailto:designassign@iagaiowa.org">designassign@aigaiowa.org</a>
	</h4>
