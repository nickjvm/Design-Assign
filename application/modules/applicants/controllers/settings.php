...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Applicants.Settings.View');
	...
	{
		$this->auth->restrict('Applicants.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_applicants())
			{
				...
				redirect(SITE_AREA .'/settings/applicants');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Applicants.Settings.Edit');
		...
		{
			$this->auth->restrict('Applicants.Settings.Delete');
