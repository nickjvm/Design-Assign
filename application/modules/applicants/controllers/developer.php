...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Applicants.Developer.View');
	...
	{
		$this->auth->restrict('Applicants.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_applicants())
			{
				...
				redirect(SITE_AREA .'/developer/applicants');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Applicants.Developer.Edit');
		...
		{
			$this->auth->restrict('Applicants.Developer.Delete');
