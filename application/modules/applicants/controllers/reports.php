...
class reports extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Applicants.Reports.View');
	...
	{
		$this->auth->restrict('Applicants.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_applicants())
			{
				...
				redirect(SITE_AREA .'/reports/applicants');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Applicants.Reports.Edit');
		...
		{
			$this->auth->restrict('Applicants.Reports.Delete');
