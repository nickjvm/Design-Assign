...
function check_method_arguments($item, $arguments, $class_only=FALSE)
{
	$ci =& get_instance();

	$segments = explode("/",$arguments);
...
function check_class_arguments($item, $arguments, $class_only=FALSE)
{
	$ci =& get_instance();
